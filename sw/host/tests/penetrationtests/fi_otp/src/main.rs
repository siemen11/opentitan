...
fn run_fi_otp_testcase(
    ...
    match test_case.command.as_str() {
        "HwCfg" => OtpFiSubcommand::HwCfg,
        "Init" => OtpFiSubcommand::Init,
        "LifeCycle" => OtpFiSubcommand::LifeCycle,
        "OwnerSwCfg" => OtpFiSubcommand::OwnerSwCfg,
        "VendorTest" => OtpFiSubcommand::VendorTest,
        _ => panic!("Unsupported Otp FI subcommand"),
    }
    .send(uart)?;
