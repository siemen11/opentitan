...
fn run_fi_rng_testcase(
    ...
    match test_case.command.as_str() {
        "CsrngInit" => RngFiSubcommand::CsrngInit,
        "CsrngBias" => RngFiSubcommand::CsrngBias,
        "CsrngBiasFWOverride" => RngFiSubcommand::CsrngBiasFWOverride,
        "CsrngBiasFWOverrideStatic" => RngFiSubcommand::CsrngBiasFWOverrideStatic,
        "EdnInit" => RngFiSubcommand::EdnInit,
        "EdnRespAck" => RngFiSubcommand::EdnRespAck,
        "EdnBias" => RngFiSubcommand::EdnBias,
        "FWOverride" => RngFiSubcommand::FWOverride,
        "EntropySrcBias" => RngFiSubcommand::EntropySrcBias,
        _ => panic!("Unsupported Rng FI subcommand"),
    }
    .send(uart)?;
