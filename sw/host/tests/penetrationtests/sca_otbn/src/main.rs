...
fn run_sca_otbn_testcase(
    ...
    match test_case.command.as_str() {
        "Init" => OtbnScaSubcommand::Init,
        "EcdsaP256Sign" => OtbnScaSubcommand::EcdsaP256Sign,
        "EcdsaP256SignBatch" => OtbnScaSubcommand::EcdsaP256SignBatch,
        "EcdsaP256SignFvsrBatch" => OtbnScaSubcommand::EcdsaP256SignFvsrBatch,
        "Rsa512Decrypt" => OtbnScaSubcommand::Rsa512Decrypt,
        _ => panic!("Unsupported OTBN SCA subcommand"),
    }
    .send(uart)?;
