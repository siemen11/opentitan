...
def char_combi_operations_batch(
    target, iterations, num_segments, trigger, fixed_data1, fixed_data2
):
    target.reset_target()
...
def char_register_file_read(target, iterations, data):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_register_file_read_batch_fvsr(target, iterations, data, num_segments):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_register_file_read_batch_random(target, iterations, num_segments):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_register_file_write(target, iterations, data):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_register_file_write_batch_fvsr(target, iterations, data, num_segments):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_register_file_write_batch_random(target, iterations, num_segments):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_tl_read(target, iterations, data):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_tl_read_batch_fvsr(target, iterations, data, num_segments):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_tl_read_batch_fvsr_fix_address(target, iterations, data, num_segments):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_tl_read_batch_random(target, iterations, num_segments):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_tl_read_batch_random_fix_address(target, iterations, num_segments):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_tl_write(target, iterations, data):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_tl_write_batch_fvsr(target, iterations, data, num_segments):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_tl_write_batch_fvsr_fix_address(target, iterations, data, num_segments):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_tl_write_batch_random(target, iterations, num_segments):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_tl_write_batch_random_fix_address(target, iterations, num_segments):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
