...
def char_aes_single_encrypt(target, iterations, fpga, masking, key, text):
    target.reset_target()
...
def char_aes_batch_fvsr_key(target, iterations, num_segments, fpga, masking, key):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_aes_batch_random(target, iterations, num_segments, fpga, masking, key):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
