...
def char_aes(target, iterations, plaintext, key, trigger):
    target.reset_target()
...
def char_kmac(target, iterations, trigger):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_kmac_state(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_shadow_reg_access(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_shadow_reg_read(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
