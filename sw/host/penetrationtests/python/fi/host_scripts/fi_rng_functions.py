...
def char_csrng_bias(target, iterations, trigger):
    target.reset_target()
...
def char_edn_resp_ack(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_edn_bias(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_entropy_bias(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
