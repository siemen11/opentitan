...
def char_address_translation(target, iterations):
    target.reset_target()
...
def char_address_translation_config(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_addi_single_beq(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_addi_single_beq_cm(target):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_addi_single_beq_cm2(target):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_addi_single_beq_neg(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_addi_single_bne(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_addi_single_bne_neg(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_combi(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_conditional_branch_beq(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_conditional_branch_bge(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_conditional_branch_bgeu(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_conditional_branch_blt(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_conditional_branch_bltu(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_conditional_branch_bne(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_csr_read(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_csr_write(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_csr_combi(target, trigger, ref_values, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_flash_read(target, flash_region, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_flash_write(target, flash_region, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_hardened_check_eq_complement_branch(target):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_hardened_check_eq_unimp(target):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_hardened_check_eq_2_unimps(target):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_hardened_check_eq_3_unimps(target):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_hardened_check_eq_4_unimps(target):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_hardened_check_eq_5_unimps(target):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_mem_op_loop(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_register_file(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_register_file_read(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_reg_op_loop(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_single_beq(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_single_bne(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_sram_read(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_sram_read_ret(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_sram_static(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_sram_write(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_sram_write_read(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_sram_write_read_alt(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_sram_write_static_unrolled(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_unconditional_branch(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_unconditional_branch_nop(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_unrolled_mem_op_loop(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_unrolled_reg_op_loop(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_unrolled_reg_op_loop_chain(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_otp_data_read(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_otp_read_lock(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
