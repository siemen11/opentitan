...
def char_beq(target, iterations):
    target.reset_target()
...
def char_bn_rshi(target, iterations, data):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_bn_sel(target, iterations, data):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_bn_wsrr(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_bne(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_dmem_access(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_dmem_write(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_dmem_op_loop(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_jal(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_mem(target, iterations, byte_offset, num_words, imem, dmem):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_unrolled_dmem_op_loop(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_load_integrity(target, iterations):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
...
def char_pc(target, iterations, pc):
    target.reset_target()
    # Clear the output from the reset
    target.dump_all()
