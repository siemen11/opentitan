 ...
 *
 * The goal of this test is to manipulate LW instructions.
 *
...
status_t handle_otbn_fi_char_lw(ujson_t *uj) {
  ...
  static const otbn_addr_t kOtbnMemOut = OTBN_ADDR_T_INIT(otbn_char_lw, mem_out);
...
status_t handle_otbn_fi_char_bn_sel(ujson_t *uj) {
  ...
  static const otbn_addr_t kOtbnAppCharBnSelBigNum = OTBN_ADDR_T_INIT(otbn_char_bn_sel, big_num);
  static const otbn_addr_t kOtbnAppCharBnSelBigNumOut = OTBN_ADDR_T_INIT(otbn_char_bn_sel, big_num_out);

  // Load app and write received big_num into DMEM.
  otbn_load_app(kOtbnAppCharBnSel);
  TRY(dif_otbn_dmem_write(&otbn, kOtbnAppCharBnSelBigNum, uj_data.big_num, sizeof(uj_data.big_num)));
  ...
  otbn_fi_big_num_out_t uj_output;
  memset(uj_output.big_num, 0, sizeof(uj_output.big_num));
  TRY(dif_otbn_dmem_read(&otbn, kOtbnAppCharBnSelBigNumOut, uj_output.big_num, sizeof(uj_output.big_num)));
...
status_t handle_otbn_fi_char_mem(ujson_t *uj) {
  ...
  if (!char_mem_init) {
    if (char_mem_dmem) {
      TRY(dif_otbn_dmem_write(&otbn, char_mem_byte_offset, dmem_array_ref, sizeof(dmem_array_ref)));
    }
    if (char_mem_imem) {
      TRY(dif_otbn_imem_write(&otbn, char_mem_byte_offset, imem_array_ref, sizeof(imem_array_ref)));
    }
    char_mem_init = true;
  }
  ...
  if (char_mem_dmem) {
    ...
    TRY(dif_otbn_dmem_read(&otbn, char_mem_byte_offset, dmem_array_res, sizeof(dmem_array_ref)));
  ...
  if (char_mem_imem) {
    TRY(dif_otbn_imem_read(&otbn, char_mem_byte_offset, imem_array_res, sizeof(imem_array_ref)));
    fault_pos = 0;
    for (size_t it = 0; it < char_mem_num_words; it++) {
...
status_t handle_otbn_fi_char_dmem_write(ujson_t *uj) {
  ...
  static const otbn_app_t kOtbnAppCharDmemWrite = OTBN_APP_T_INIT(otbn_char_dmem_write);
  static const otbn_addr_t kOtbnVarCharDmemWriteMem = OTBN_ADDR_T_INIT(otbn_char_dmem_write, mem);
  ...
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem), ref_values[0]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 4), ref_values[1]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 8), ref_values[2]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 12), ref_values[3]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 16), ref_values[4]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 20), ref_values[5]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 24), ref_values[6]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 28), ref_values[7]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 32), ref_values[8]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 36), ref_values[9]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 40), ref_values[10]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 44), ref_values[11]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 48), ref_values[12]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 52), ref_values[13]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 56), ref_values[14]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 60), ref_values[15]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 64), ref_values[16]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 68), ref_values[17]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 72), ref_values[18]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 76), ref_values[19]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 80), ref_values[20]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 84), ref_values[21]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 88), ref_values[22]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 92), ref_values[23]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 96), ref_values[24]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 100), ref_values[25]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 104), ref_values[26]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 108), ref_values[27]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 112), ref_values[28]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 116), ref_values[29]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 120), ref_values[30]);
  mmio_region_write32(otbn.base_addr, (ptrdiff_t)(OTBN_DMEM_REG_OFFSET + kOtbnVarCharDmemWriteMem + 124), ref_values[31]);
  asm volatile(NOP10);
  sca_set_trigger_low();
  ...
  memset(res_values, 0, sizeof(res_values));
  TRY(dif_otbn_dmem_read(&otbn, kOtbnVarCharDmemWriteMem, res_values, sizeof(res_values)));
