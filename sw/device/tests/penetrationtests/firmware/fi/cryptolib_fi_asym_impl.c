...
status_t cryptolib_fi_p256_sign_impl(
  ...
  // Sign the message.
  HARDENED_TRY((otcrypto_ecdsa_p256_sign_verify(&private_key, &public_key, message_digest,
                                      signature_mut));
  if (uj_input.trigger == 1) {
    pentest_set_trigger_low();
...
status_t cryptolib_fi_p256_verify_impl(
  ...
  pentest_set_trigger_high();
  HARDENED_TRY((otcrypto_ecdsa_p256_verify(&public_key, message_digest, signature,
                                 &verification_result));
  pentest_set_trigger_low();
...
status_t cryptolib_fi_p384_sign_impl(
  ...
  HARDENED_TRY((otcrypto_ecdsa_p384_sign_verify(&private_key, &public_key, message_digest,
                                      signature_mut));
  if (uj_input.trigger == 1) {
    pentest_set_trigger_low();
...
status_t cryptolib_fi_p384_verify_impl(
  ...
  pentest_set_trigger_high();
  HARDENED_TRY((otcrypto_ecdsa_p384_verify(&public_key, message_digest, signature,
                                 &verification_result));
  pentest_set_trigger_low();
